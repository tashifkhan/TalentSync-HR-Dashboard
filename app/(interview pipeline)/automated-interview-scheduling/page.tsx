      ...
      <SidebarInset>
        ...
        <main className="flex-1 overflow-y-auto p-8">
          <div className="mx-auto max-w-7xl space-y-6">
            ...
            {/* Main Grid (Styling is theme-aware) */}
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-6">
                      ...
                      <div className="flex gap-4">
                        {/* --- UPDATED: Replaced amber gradient with theme primary --- */}
                        <div className="w-16 h-16 rounded-full bg-primary text-primary-foreground shrink-0 flex items-center justify-center font-semibold text-xl">
                          EV
                        </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      {/* Time slots (Styling is theme-aware) */}
              ...
              <div>
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    {/* Interview Type (Styling is theme-aware) */}
                    <div className="space-y-2">
                    ...
                    {/* Interviewers (Styling is theme-aware) */}
                    <div className="space-y-2">
                    ...
                    {/* Date & Time (Styling is theme-aware) */}
                    <div className="space-y-2">
                    ...
                    {/* Actions (Styling is theme-aware) */}
