                      ...
                      <div className="flex gap-1">
                        {[1, 2, 3, 4, 5].map(rating => (
                          <button
                            key={rating}
                            className={`text-lg ${
                              rating <= criterion.rating ? 'text-yellow-400' : 'text-muted-foreground'
                            }`}
                          >
                            ★
                          </button>
                  ...
                  {questions.map((question, idx) => (
                    <div key={question.id} className="p-4 border rounded-lg space-y-3">
                      ...
                      <div className="flex items-center justify-between pt-2 border-t">
                        ...
                        <div className="flex gap-1">
                          {[1, 2, 3, 4, 5].map(rating => (
                            <button key={rating} className="text-lg text-muted-foreground hover:text-yellow-400 transition">
                              ★
                            </button>
                          ))}
                        </div>
