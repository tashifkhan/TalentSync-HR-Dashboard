		...
		<div className="space-y-4">
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
				<Card>
					...
					<CardContent>
						<div
							className="h-64 border border-dashed rounded"
							style={{ borderColor: "var(--ts-border)" }}
						/>
						<p className="text-xs text-[var(--ts-text-muted-50)] mt-2">
				...
				<Card>
					...
					<CardContent className="space-y-2 text-sm text-[var(--ts-text-muted-70)]">
						...
						<div
							...
							style={{ borderColor: "var(--ts-border)" }}
						>
							<div className="font-medium text-[var(--ts-text)]">
								AI-Generated Interview Questions
							</div>
							<ul className="list-disc pl-5 mt-1">
								<li>
									Explain how you optimize React performance in large apps.
								</li>
