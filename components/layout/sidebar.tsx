	...
	return (
		...
		>
			<div className="p-4 border-b" style={{ borderColor: "var(--ts-border)" }}>
				...
				<div className="text-xs" style={{ color: "var(--ts-text-muted-50)" }}>
					Pro/HR
				</div>
			</div>
					...
					return (
						<Link
							...
							className={[
								...
								active
									? "bg-[var(--ts-bg-2)] text-[var(--ts-accent)]"
									: "text-[var(--ts-text)] hover:bg-[var(--ts-bg-2)]",
							].join(" ")}
						>
							{item.label}
						</Link>
			...
			<div className="p-4 text-xs" style={{ color: "var(--ts-text-muted-40)" }}>
				v0.1.0
			</div>
		</aside>
	);
